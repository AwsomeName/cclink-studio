...
| 类别     | 里程碑 | 交付结果                             | 估算工作量             | 可对外描述                   |
| -------- | ------ | ------------------------------------ | ---------------------- | ---------------------------- |
| 工程前置 | R0     | 双架构签名、公证、Draft Release      | 已实现，真人验收待补   | 仅报告工程准备度             |
| 工程前置 | U0     | Manifest、共享契约和发布元数据       | 已完成                 | 仅报告工程准备度             |
| 用户功能 | U1     | 检查服务、状态机和更新界面           | 5-7 人日               | 支持自动和手动检查更新       |
| 用户功能 | U2     | 应用内可靠下载、校验和恢复           | 5-7 人日               | 支持受控下载和完整性校验     |
| 用户功能 | U3     | 已校验 DMG 的辅助安装闭环            | 2-3 人日               | 支持打开可信安装包并引导替换 |
| 用户功能 | U4     | 用户确认后的自动安装、工作保护和重启 | 8-12 人日              | 支持确认后自动安装并重启     |
| 用户功能 | U5     | 两轮真实发布稳定化、诊断和运营门禁   | 3-5 人日加两个发布周期 | 更新能力达到长期维护基线     |
