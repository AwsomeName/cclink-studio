...
状态：业务细步骤已接入；无图文章的正文、恢复、摘要、标签、保存、公开提交和结果核验已验收；完整矩阵未验收
日期：2026-09-08
...
本节描述修复前的问题。当前实现和真实验收范围以
[开发方案](article-publishing-observable-execution-development-plan.md) 和
[验收记录](../testing/article-publishing-plan-acceptance-2026-09-08.md) 为准。
