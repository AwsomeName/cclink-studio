...
> 状态：R1/R4 已完成，固定版本检查/修复/卸载已完成，R2 待真机验收，R3 已完成制品准备但尚不能激活；R5 真实双版本更新自 2026-08-15 起暂停。最后更新：2026-08-15。
...
| R5 真实更新     | 用户功能 | 两个兼容版本之间更新、坏版本回滚           | 已暂停；只有出现第二兼容版本和真实产品需求才重启 |
...
- 通用远程签名目录、旧版本垃圾回收、真实双版本回滚：未实现且已暂停；当前固定版本卸载已实现。
