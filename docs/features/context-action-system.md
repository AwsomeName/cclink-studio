...
> 状态：M1-M4 已完成；M5 实现中。日期：2026-07-22。
...
> 状态：实现中；完成后按 `docs/ops/context-action-m5-acceptance.md` 逐项验收。
...
- 2026-07-22 当前工作树门禁：`pnpm verify` 通过（155 files / 937 tests），`pnpm smoke:standalone` 通过（local 9/9、UI 6/6、workflow 9/9、restore 4/4）；提交后的全新 detached worktree 和 H1-H5 真人验收仍待完成。
