...
export async function shutdownRuntime(runtime: CclinkStudioRuntimeState): Promise<void> {
  ...
  registry.register({
    name: 'ActiveDeviceManager',
    stop: () => runtime.activeDeviceManager?.destroy(),
  })
  registry.register({
    name: 'AgentDeviceManager',
    stop: () => runtime.agentDeviceManager?.destroy(),
  })
  registry.register({
    name: 'PhysicalDeviceManager',
    stop: () => runtime.physicalDeviceManager?.disconnect(),
  })
  ...
  registry.register({
    name: 'TerminalConfirmationService',
    stop: () => runtime.terminalConfirmationService?.destroy(),
  })
  registry.register({
